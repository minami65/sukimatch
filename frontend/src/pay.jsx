          ...
          <div className="form">
            ...
            <div className="field">
              ...
              <div className="expiry">
                <input type="number" id="expiration_year" name="expiration_date" required />
                <span>年</span>
                <input type="number" id="expiration_month" name="expiration_date" required />
                <span>月</span>
                <input type="number" id="expiration_day" name="expiration_date" required />
                <span>日</span>
              </div>
            </div>
            <div className="field">
